...
def test_QKF_GSM_gsm_proc_est():
    ...
    filt.set_process_noise_model(initial_est=2 * proc_cov, filter_length=None,
                                 startup_delay=5)
    ...
    if debug_figs:
        ...
        for ii in range(4):
            ...
            figs['p_covs04'].axes[ii].plot(time[[0, -1]],
                                           proc_cov[ii, ii] * np.ones(2),
                                           color='k')
        ...
        for ii in range(2):
            ...
            figs['p_covs46'].axes[ii].plot(time[[0, -1]],
                                           proc_cov[jj, jj] * np.ones(2),
                                           color='k')
