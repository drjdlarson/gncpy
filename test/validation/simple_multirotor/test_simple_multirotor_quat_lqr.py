"""LQR control validation for SimpleMultirotorQuat.

This test validates the SimpleMultirotorQuat dynamics (using quaternions) by
implementing LQR control to command the vehicle from hover to a target waypoint.
"""
...
# ============================================================================
print("Initializing vehicle with motor dynamics (quaternion version)...")
...
vehicle = SimpleMultirotorQuat(str(config_file), effector=motor_effector)
...
plt.tight_layout()
output_file = Path(__file__).parent / "ValidationResults/lqr_quat_results.png"
