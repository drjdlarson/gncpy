...
test_scenarios = [
    ("Test 1: Circular Velocity", 10.0, ref_test1, "test1_circular_velocity"),
    ("Test 2: Moderate Roll", 10.0, ref_test2, "test2_moderate_roll"),
    ("Test 3: Combined Vel+Att", 12.0, ref_test3, "test3_combined"),
    ("Test 4: Helix+MultiAxis", 12.0, ref_test4, "test4_helix_multiaxis"),
]
