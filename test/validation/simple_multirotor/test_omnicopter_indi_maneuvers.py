...
output_file_1 = output_dir / "indi_test1_circular_velocity.png"
...
output_file_2 = output_dir / "indi_test2_360_roll.png"
...
output_file_3 = output_dir / "indi_test3_combined.png"
plt.savefig(output_file_3, dpi=150)
print(f"Test 3 figure saved to: {output_file_3}")


# ============================================================================
# Test 4: Helix trajectory with full 3-axis tumbling
# ============================================================================
print("\n" + "=" * 70)
print("TEST 4: Helix Trajectory with 3-Axis Tumble")
print("=" * 70)
...
output_file_4 = output_dir / "indi_test4_helix_tumble.png"
