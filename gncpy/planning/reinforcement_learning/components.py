...
class CBirth:
    ...
    def __init__(self, b_type=None, loc=None, scale=None, params=None, rng=None,
                 randomize=True):
...
class CDynamics:
    ...
    def __init__(self, dynObj=None, pos_inds=None, vel_inds=None, state_args=None,
                 ctrl_args=None, state_low=None, state_high=None):
        """Initialize an object.
